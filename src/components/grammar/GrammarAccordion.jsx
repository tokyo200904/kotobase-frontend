      ...
      >
        <div className="border-t border-gray-50 p-4 dark:border-gray-800">
          <Link
            ...
            className="group flex w-full items-center justify-between rounded-xl bg-primary/5 p-3 transition-colors hover:bg-primary/10 dark:bg-primary/10 dark:hover:bg-primary/20"
          >
            <div className="flex items-center gap-3">
