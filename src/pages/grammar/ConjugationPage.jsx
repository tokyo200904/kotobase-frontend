  ...
  return (
    <div className="custom-scrollbar h-[calc(100vh-6rem)] w-full overflow-y-auto pr-2 md:pr-4">
      ...
      <div className="mx-auto max-w-6xl space-y-6 pb-10 pt-2">
        ...
        <div className="flex w-fit rounded-2xl bg-gray-100/80 p-1.5 shadow-inner backdrop-blur-sm dark:bg-gray-800/80">
          <button
            onClick={() => setActiveTab('verbs')}
            className={`rounded-xl px-6 py-2.5 text-sm font-bold transition-all duration-300 ${
              activeTab === 'verbs' 
                ? 'scale-100 bg-white text-primary shadow-sm dark:bg-gray-900 dark:text-white' 
                : 'scale-95 text-gray-500 hover:scale-100 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white'
            }`}
          >
            Động từ (Verbs)
          </button>
              ...
              {VERB_CONJUGATION.map((groupData, index) => (
                <div key={index} className="overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="custom-scrollbar overflow-x-auto">
                    <table className="w-full min-w-[600px] text-left text-sm text-gray-700 dark:text-gray-300">
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="m-4 flex items-start gap-3 rounded-xl bg-blue-50 p-4 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
                ...
                <div className="text-sm">
                  ...
                  <p className="mt-1">
                    Tính từ <strong className="font-bold">いい</strong> (Tốt) là trường hợp đặc biệt. Khi chia sang phủ định hoặc quá khứ, nó biến thành <strong className="font-bold">よい (yoi)</strong>.<br/>
